...
import {
  ...
  getRouteAbout,
  getRouteArticle,
  getRouteArticleAdmin,
  getRouteArticleCreate,
  getRouteArticleDetails,
  getRouteArticleEdit,
  getRouteArticleForbidden,
  getRouteMain,
  getRouteProfile,
...
export const RoutePath: Record<AppRouter, string> = {
  ...
  [AppRouter.ARTICLES]: getRouteArticle(),
  [AppRouter.ARTICLES_DETAILS]: getRouteArticleDetails(':id'),

  [AppRouter.ADMIN_PANEL]: getRouteArticleAdmin(),
  [AppRouter.FORBIDDEN]: getRouteArticleForbidden(),
...
export const RouteConfig: Record<AppRouter, AppRoutesProps> = {
  [AppRouter.ADMIN_PANEL]: {
    path: getRouteArticleAdmin(),
    element: <AdminPanelPage />,
    roles: [UserRole.MANAGER, UserRole.ADMIN],
  },
  [AppRouter.FORBIDDEN]: {
    path: getRouteArticleForbidden(),
...
//! Также как и AppRouter должен быть в shared/consts/router
// export const RoutePath: Record<AppRouter, string> = {
//   [AppRouter.MAIN]: '/',
